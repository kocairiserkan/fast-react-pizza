      ...
      <Form method="POST">
        ...
        <div className="relative mb-5 flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="grow">
            ...
            {addressStatus === 'error' && <p className="mt-2 rounded-md bg-red-100 p-2 text-xs text-red-700">{errorAddress} error</p>}
          </div>
...
export async function action({request}){
  ...
  errors.phone = "Please give us your correct phone number. We might need it to cantact you."} 
